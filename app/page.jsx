...
const comprobantes = [
  { value: "01", name: "FACTURAS A" },
  { value: "02", name: "NOTAS DE DEBITO A" },
  { value: "03", name: "NOTAS DE CREDITO A" },
  { value: "04", name: "RECIBOS A" },
  { value: "05", name: "NOTAS DE VENTA AL CONTADO A" },
  { value: "06", name: "FACTURAS B" },
  { value: "07", name: "NOTAS DE DEBITO B" },
  { value: "08", name: "NOTAS DE CREDITO B" },
  { value: "09", name: "RECIBOS B" },
  { value: "10", name: "NOTAS DE VENTA AL CONTADO B" },
  { value: "11", name: "FACTURAS C" },
  { value: "12", name: "NOTAS DE DEBITO C" },
  { value: "13", name: "NOTAS DE CREDITO C" },
  { value: "15", name: "RECIBOS C" },
  { value: "16", name: "NOTAS DE VENTA AL CONTADO C" },
  { value: "17", name: "LIQUIDACION DE SERVICIOS PUBLICOS CLASE A" },
  { value: "18", name: "LIQUIDACION DE SERVICIOS PUBLICOS CLASE B" },
  { value: "19", name: "FACTURAS DE EXPORTACION" },
  { value: "20", name: "NOTAS DE DEBITO POR OPERACIONES CON EL EXTERIOR" },
  { value: "21", name: "NOTAS DE CREDITO POR OPERACIONES CON EL EXTERIOR" },
  {
    value: "22",
  ...
  { value: "27", name: "LIQUIDACION UNICA COMERCIAL IMPOSITIVA CLASE A" },
  { value: "28", name: "LIQUIDACION UNICA COMERCIAL IMPOSITIVA CLASE B" },
  { value: "29", name: "LIQUIDACION UNICA COMERCIAL IMPOSITIVA CLASE C" },
  { value: "30", name: "COMPROBANTES DE COMPRA DE BIENES USADOS" },
  { value: "31", name: "MANDATO - CONSIGNACION" },
  { value: "32", name: "COMPROBANTES PARA RECICLAR MATERIALES" },
  { value: "33", name: "LIQUIDACION PRIMARIA DE GRANOS" },
  {
    value: "34",
  ...
  { value: "39", name: "OTROS COMPROBANTES A QUE CUMPLEN CON LA R G  1415" },
  {
    value: "40",
  ...
  { value: "50", name: "RECIBO FACTURA A  REGIMEN DE FACTURA DE CREDITO" },
  { value: "51", name: "FACTURAS M" },
  { value: "52", name: "NOTAS DE DEBITO M" },
  { value: "53", name: "NOTAS DE CREDITO M" },
  { value: "54", name: "RECIBOS M" },
  { value: "55", name: "NOTAS DE VENTA AL CONTADO M" },
  {
    value: "56",
  ...
  { value: "58", name: "CUENTAS DE VENTA Y LIQUIDO PRODUCTO M" },
  { value: "59", name: "LIQUIDACIONES M" },
  { value: "60", name: "CUENTAS DE VENTA Y LIQUIDO PRODUCTO A" },
  { value: "61", name: "CUENTAS DE VENTA Y LIQUIDO PRODUCTO B" },
  { value: "63", name: "LIQUIDACIONES A" },
  { value: "64", name: "LIQUIDACIONES B" },
  { value: "66", name: "DESPACHO DE IMPORTACION" },
  { value: "68", name: "LIQUIDACION C" },
  { value: "70", name: "RECIBOS FACTURA DE CREDITO" },
  {
    value: "80",
    name: "INFORME DIARIO DE CIERRE (ZETA) - CONTROLADORES FISCALES",
  },
  { value: "81", name: "TIQUE FACTURA A" },
  { value: "82", name: "TIQUE FACTURA B" },
  { value: "83", name: "TIQUE" },
  { value: "88", name: "REMITO ELECTRONICO" },
  { value: "89", name: "RESUMEN DE DATOS" },
  {
    value: "90",
    name: "OTROS COMPROBANTES - DOCUMENTOS EXCEPTUADOS - NOTAS DE CREDITO",
  },
  { value: "91", name: "REMITOS R" },
  {
    value: "99",
